      ...
      <div className="container-custom">
        <div className="flex flex-col lg:flex-row items-center">
          ...
          <div className="w-full lg:w-1/2 relative animate-fade-in">
            ...
            <div className="absolute -top-4 -left-4 w-24 h-24 bg-blue-500/10 rounded-lg -z-10 animate-pulse"></div>
            <div className="absolute -bottom-4 -right-4 w-32 h-32 bg-cyan-500/20 rounded-lg -z-10 animate-pulse"></div>
          </div>
        </div>
      </div>
    </section>
